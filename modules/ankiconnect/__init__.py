...
def setup_ankiconnect():
    global _ac_instance
    if _ac_instance is not None:
        return _ac_instance
    try:
        ...
        _ac_instance = AnkiConnect()
        _ac_instance.initLogging()
        _ac_instance.startWebServer()
        return _ac_instance
    except Exception as e:
        print(f"AnkiConnect startup warning: {e}")
        return None
