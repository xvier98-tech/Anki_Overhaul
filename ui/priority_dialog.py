...
from ..core.reorder import count_new_cards_by_deck, run_reorder_with_ui
from ..core.models import DeckNode
...
class PriorityManagerDialog(QDialog):
    ...
    def _setup_ui(self):
        ...
        # Selected Deck Priority Editor Group
    ...
    def refresh_deck_tree(self):
        """Builds and populates the QTreeWidget based on current collection state."""
        ...
        # Map to store QTreeWidgetItem by deck_id
